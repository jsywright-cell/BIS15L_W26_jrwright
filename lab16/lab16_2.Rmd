...
```{}
mv genome01_blastn.csv > BIS15L_W26_jrwright/lab16/data/blast_results/
ls 
...
```{r}
dna_file <- readDNAStringSet("data/e.coli_genbank.fasta") #cannot use read_csv for fasta file
```
...
```{r}
aa_file <- readAAStringSet("data/e.coli_cds.fast")
```
