...
## Practice
1. Build a scatterplot that compares `log10_mass` and `log10_preymass`. Store this plot as object `q`. Color by thermoregulation.
```{r}
q <- homerange |> 
...
```{r}
display.brewer.pal(9,"Set3") #qualitative palette
```
