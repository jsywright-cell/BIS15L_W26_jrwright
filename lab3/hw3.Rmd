...
height_feet <- c(29031.7, 28251, 28169, 27940, 27838)
...
```{r}
mountains$summits <- c(12884, 964, 532, 933, 499)
```
...
```{r}
mountains$fatalities <- c(344, 96, 53, 20, 35)
```
...
```{r}
mountains$fatality_rate <- c(0.03, 0.10, 0.10, 0.02, 0.07)
```

**8. Write your data frame to a .csv file called `mountains_data`.**
```{r}
mountains_data <- read.csv("mountains_data.csv")
```
